    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      ...
      <Card className="w-full max-w-md relative z-10 border-primary/20 shadow-2xl shadow-primary/10">
        <CardHeader className="space-y-3 pb-6 text-center">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight">HelpIT Command Center</CardTitle>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="technician@company.com" {...field} className="bg-background" />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
